...
@section('content')
    ...
    @endif
        ...
        <h1 class="py-3">Edit Data Pembeli</h1>
            ...
            <div class="row">
                <form method="post" action="/pembeli/{{ $pembeli->id
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input name="namapembeli" type="text" class="form-control mt-2"
                            id="exampleInputEmail1"
                                aria-describedby="EmailHelp" placeholder="Nama
                                Pembeli" value="{{ $pembeli->namapembeli }}">

                    </div>

                    <div class="form-group mb-3">
                        <label for="exampleInputEmail1">No Pembeli</label>
                        <input name="nopembeli" type="text" class="form-control mt-2"
                            id="exampleInputEmail1"
                            aria-describedby="EmailHelp" placeholder="No
                                Pembeli" value="{{ $pembeli->nopembeli }}">
                    </div>

                    <div class="form-group mb-3">
                        <label for="exampleFormControlTextarea1">Alamat</label>
                        <textarea name="alamatpembeli" class="form-control mt-2"
                            id="exampleFormControlTextarea1" rows="3"
                            placeholder="Alamat Pembeli">{{ $pembeli->alamatpembeli
                            }}</textarea>
                    </div>
                    ...
                    <div class="form-group mt-5">
                        ...
                        <a href="/pembeli" class="btn btn-danger mx-3">Cancel</a>
                    </div>
                </form>
