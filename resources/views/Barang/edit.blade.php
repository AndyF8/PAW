            ...
            <div class="row">
                <form method="post" action="/barang/{{ $barang->id
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input name="namabarang" type="text" class="form-control mt-2"
                            id="exampleInputEmail1"
                                aria-describedby="EmailHelp" placeholder="Nama
                                Barang" value="{{ $barang->namabarang }}">

                    </div>

                    <div class="form-group mb-3">
                        <label for="exampleInputEmail1">Harga</label>
                        <input name="hargajual" type="text" class="form-control mt-2"
                            id="exampleInputEmail1"
                            aria-describedby="EmailHelp" placeholder="Harga
                                Barang" value="{{ $barang->hargajual }}">
                    </div>

                    <div class="form-group mb-3">
                        <label for="exampleInputEmail1">Jenis </label>
                        <input name="jenisbarang" type="text" class="form-control mt-2"
                            id="exampleInputEmail1"
                            aria-describedby="EmailHelp" placeholder="Jenis
                                Barang" value="{{ $barang->jenisbarang }}">
                    </div>

                    <div class="form-group mb-3">
                        <label for="exampleInputEmail1">Stock Barang</label>
                        <input name="stockbarang" type="text" class="form-control mt-2"
                            id="exampleInputEmail1"
                            aria-describedby="EmailHelp" placeholder="Stock
                                Barang" value="{{ $barang->stockbarang }}">
                    </div>
                    ...
                    <div class="form-group mt-5">
                        ...
                        <a href="/barang" class="btn btn-danger mx-3">Cancel</a>
                    </div>
                </form>
